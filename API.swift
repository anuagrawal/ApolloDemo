...
public final class SpecificCountryQuery: GraphQLQuery {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct Country: GraphQLSelectionSet {
      ...
      public init(name: String, native: String, capital: String? = nil, emoji: String, currency: String? = nil) {
        self.init(unsafeResultMap: ["__typename": "Country", "name": name, "native": native, "capital": capital, "emoji": emoji, "currency": currency])
      }
